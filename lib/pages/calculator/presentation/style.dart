...
TextStyle inputStyle = const TextStyle(fontFamily: 'Changa', height: 1, fontSize: 48, /*backgroundColor: Colors.green,*/ overflow: TextOverflow.clip);
...
BoxDecoration circButton =  BoxDecoration(
    ...
    boxShadow: [BoxShadow(color:Colors.black.withOpacity(0.40), offset: Offset(-8, 4), blurRadius: 10 )],
    borderRadius: const BorderRadius.all(Radius.circular(50)));

Color backgroundColor = const Color.fromRGBO(36, 36, 36, 1);

const TextStyle buttonsText = TextStyle(fontFamily: 'Changa', fontSize: 36, color: Colors.black, );
